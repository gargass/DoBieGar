...
shinyServer(function(input, output) {
  ...
  output$opis_krzywe <- renderText({
    ...
    print('In the figures below we can see Kaplan-Meier curves for a given gene and the given tumors. The survival curves are estimated for the two groups of patients: the first one is the group of patients with a mutation of a given gene, and the second one is the group of patients without any mutation of this gene.')
  })
